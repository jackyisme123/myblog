...
!function (e) {
    ...
    e.defineExtension("openDialog", function (o, r, n) {
        function a(e) {
            if ("string" == typeof e) h.value = e; else {
                if (c) return;
        ...
        i(this, null);
        var s = t(this, o, n && n.bottom), l = s.getElementsByTagName("button"), c = !1, d = this, h = 1;
        l[0].focus();
    ...
    function t(e, t, r, n) {
        if (this.atOccurrence = !1, this.doc = e, null == n && "string" == typeof t && (n = !1), r = r ? e.clipPos(r) : o(0, 0), this.pos = {
            ...
            if (i) {
                ...
                t.lastIndex = r.ch;
                var s = e.getLine(r.line), n = t.exec(s), d = n && n[0].length || 0, a = n && n.index;
                a + d == s.length || d || (d = 1)
            }
            ...
            if (1 == l.length) t.length ? this.matches = function (r, n) {
                if (r) {
                    var l = e.getLine(n.line).slice(0, n.ch), c = s(l), d = c.lastIndexOf(t);
                    if (d > -1) return d = i(l, c, d), {from: o(n.line, d), to: o(n.line, d + a.length)}
                } else {
                    var l = e.getLine(n.line).slice(n.ch), c = s(l), d = c.indexOf(t);
                    if (d > -1) return d = i(l, c, d) + n.ch, {from: o(n.line, d), to: o(n.line, d + a.length)}
                }
                ...
                this.matches = function (t, i) {
                    ...
                    if (t) {
                        ...
                        var h = e.getLine(a), u = h.length - c[0].length;
                        if (s(h.slice(u)) != l[0]) return;
                        return {from: o(a, u), to: n}
                    }
                    if (!(i.line + (l.length - 1) > e.lastLine())) {
                        var h = e.getLine(i.line), u = h.length - c[0].length;
                        if (s(h.slice(u)) == l[0]) {
                            for (var f = o(i.line, u), a = i.line + 1, d = 1; r > d; ++d, ++a) if (l[d] != s(e.getLine(a))) return;
                            if (s(e.getLine(a).slice(0, c[r].length)) == l[r]) return {from: f, to: o(a, c[r].length)}
                        }
                    }
                }
            }
    ...
    function d(t, i) {
        t.operation(function () {
            var r = o(t), a = n(t, r.query, i ? r.posFrom : r.posTo);
        ...
        e.getOption("readOnly") || a(e, g, "Replace:", e.getSelection(), function (i) {
            i && (i = l(i), a(e, p, "Replace with:", "", function (o) {
                if (t) e.operation(function () {
                    ...
                    h(e);
                    var r = n(e, i, e.getCursor()), a = function () {
                        var t, o = r.from();
    ...
    e.defineExtension("annotateScrollbar", function (e) {
        ...
        var t = this.cm, i = this.hScale, o = document.createDocumentFragment(), r = this.annotations;
        if (t.display.barWidth) for (var n, a = 0; a < r.length; a++) {
            ...
            if (c != l) {
                var d = Math.max(c - l, 3), h = o.appendChild(document.createElement("div"));
    ...
    e.defineExtension("showMatchesOnScrollbar", function (e, i, o) {
        return "string" == typeof o && (o = {className: o}), o || (o = {}), new t(this, e, i, o)
    });
    var o = 1e3;
    t.prototype.findMatches = function () {
        ...
        var o = t.from.line, r = e.changeEnd(t).line, n = r - t.to.line;
        if (this.gap ? (this.gap.from = Math.min(i(this.gap.from, o, n), t.from.line), this.gap.to = Math.max(i(this.gap.to, o, n), t.from.line)) : this.gap = {
            ...
            var s = this.matches[a], l = i(s.from.line, o, n);
    ...
    function r(e) {
        var o = e.getWrapperElement(), r = n(e);
    ...
    e.defineOption("placeholder", "", function (i, n, a) {
        var s = a && a != e.Init;
        if (n && !s) i.on("blur", o), i.on("change", r), r(i); else if (!n && s) {
    ...
    function t(t) {
        ...
        for (var i = t.listSelections(), o = [], l = 0; l < i.length; l++) {
            ...
            var c = i[l].head, d = t.getTokenAt(c), h = e.innerMode(t.getMode(), d.state), u = h.state;
            if ("xml" != h.mode.name || !u.tagName) return e.Pass;
            var f = t.getOption("autoCloseTags"), g = "html" == h.mode.configuration,
                p = "object" == typeof f && f.dontCloseTags || g && a,
                m = "object" == typeof f && f.indentTags || g && s, v = u.tagName;
    ...
    function i(t, i) {
        for (var o = t.listSelections(), r = [], a = i ? "/" : "</", s = 0; s < o.length; s++) {
            ...
            var l = o[s].head, c = t.getTokenAt(l), d = e.innerMode(t.getMode(), c.state), h = d.state;
            if (i && ("string" == c.type || "<" != c.string.charAt(0) || c.start != l.ch - 1)) return e.Pass;
            if ("xml" != d.mode.name) if ("htmlmixed" == t.getMode().name && "javascript" == d.mode.name) r[s] = a + "script>"; else {
    ...
    function n(t, i, o, r, n) {
        ...
        var a = Math.min(t.lastLine() + 1, o.line + 500), s = e.scanForClosingTag(t, o, null, a);
    ...
    function t(t, r, n, a) {
        ...
        if (d && !d.cleared && "unfold" !== a) {
            ...
            var u = t.markText(d.from, d.to, {replacedWith: h, clearOnEnter: !0, __isFold: !0});
    ...
    var r = {rangeFinder: e.fold.auto, widget: "↔", minFoldSize: 0, scanUp: !1};
    ...
    function n(e, t, i) {
        var n = e.state.foldGutter.options, a = t, s = e.foldOption(n, "minFoldSize"),
            l = e.foldOption(n, "rangeFinder");
        e.eachLine(t, i, function (t) {
            var i = null;
            if (o(e, a)) i = r(n.indicatorFolded); else {
                var c = h(a, 0), d = l && l(e, c);
    ...
    function a(e) {
        var t = e.getViewport(), i = e.state.foldGutter;
    ...
    e.registerHelper("fold", "indent", function (t, i) {
        var o = t.getOption("tabSize"), r = t.getLine(i.line);
        if (/\S/.test(r)) {
            for (var n = function (t) {
                return e.countColumn(t, null, o)
            }, a = n(r), s = null, l = i.line + 1, c = t.lastLine(); c >= l; ++l) {
                var d = t.getLine(l), h = n(d);
                if (h > a) s = l; else if (/\S/.test(d)) break
            }
    ...
    e.registerHelper("fold", "brace", function (t, i) {
        ...
        if (null == r && (l = "[", c = "]", r = o("[")), null != r) {
            ...
            e:for (var g = a; f >= g; ++g) for (var p = t.getLine(g), m = g == a ? r : 0; ;) {
                var v = p.indexOf(l, m), w = p.indexOf(c, m);
                if (0 > v && (v = p.length), 0 > w && (w = p.length), m = Math.min(v, w), m == p.length) break;
                if (t.getTokenTypeAt(e.Pos(g, m + 1)) == n) if (m == v) ++u; else if (!--u) {
                    d = g, h = m;
                    break e
                }
                ++m
            }
            if (null != d && (a != d || h != r)) return {from: e.Pos(a, r), to: e.Pos(d, h)}
        }
    ...
    function a(e) {
        for (; ;) {
            ...
            {
                if (o(e, t + 1)) {
                    var i = e.text.lastIndexOf("/", t), n = i > -1 && !/\S/.test(e.text.slice(i + 1, t));
    ...
    function c(e) {
        for (; ;) {
            ...
            {
                if (o(e, t + 1)) {
                    var i = e.text.lastIndexOf("/", t), r = i > -1 && !/\S/.test(e.text.slice(i + 1, t));
    ...
    function d(e, t) {
        for (var i = []; ;) {
            ...
            if ("selfClose" != o) if (r[1]) {
                ...
                if (0 > c && (!t || t == r[2])) return {tag: r[2], from: u(n, s), to: u(e.line, e.ch)}
            } else i.push(r[2])
        }
    }
    ...
    function h(e, t) {
        for (var i = []; ;) {
            ...
            if (!o) return;
            if ("selfClose" != o) {
                var r = e.line, n = e.ch, a = s(e);
                if (!a) return;
                if (a[1]) i.push(a[2]); else {
                    for (var l = i.length - 1; l >= 0; --l) if (i[l] == a[2]) {
                        i.length = l;
                        break
                    }
                    if (0 > l && (!t || t == a[2])) return {tag: a[2], from: u(e.line, e.ch), to: u(r, n)}
                }
            } else s(e)
        }
    }
    ...
    e.registerHelper("fold", "xml", function (e, t) {
        ...
        if (-1 != n.text.indexOf(">") || -1 != n.text.indexOf("<")) {
            var l = a(n), c = l && u(n.line, n.ch), f = l && s(n);
            if (l && f && !(t(n, o) > 0)) {
                var g = {from: u(n.line, n.ch), to: c, tag: f[2]};
                return "selfClose" == l ? {open: g, close: null, at: "open"} : f[1] ? {
                    open: h(n, f[2]),
                    close: g,
                    at: "close"
                } : (n = new i(e, c.line, c.ch, r), {open: g, close: d(n, f[2]), at: "open"})
            }
        }
        ...
        for (var r = new i(e, t.line, t.ch, o); ;) {
            var n = h(r);
            if (!n) break;
            var a = new i(e, t.line, t.ch, o), s = d(a, n.tag);
    ...
    e.registerHelper("fold", "markdown", function (t, i) {
        ...
        var n = 100, a = t.getLine(i.line), s = t.getLine(i.line + 1), l = r(i.line, a, s);
        if (l === n) return void 0;
        for (var c = t.lastLine(), d = i.line, h = t.getLine(d + 2); c > d && !(r(d + 1, s, h) <= l);) ++d, s = h, h = t.getLine(d + 2);
        return {from: e.Pos(i.line, a.length), to: e.Pos(d, t.getLine(d).length)}
    })
}), function (e) {
    "object" == typeof exports && "object" == typeof module ? e(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], e) : e(CodeMirror)
}(function (e) {
    ...
    e.registerGlobalHelper("fold", "comment", function (e) {
        ...
        var o = t.getModeAt(i), r = o.blockCommentStart, n = o.blockCommentEnd;
        if (r && n) {
            ...
            e:for (var m = s; p >= m; ++m) for (var v = t.getLine(m), w = m == s ? a : 0; ;) {
                var b = v.indexOf(r, w), y = v.indexOf(n, w);
            ...
            if (null != u && (s != u || f != a)) return {from: e.Pos(s, a), to: e.Pos(u, f)}
        }
    })
}), function (e) {
    "object" == typeof exports && "object" == typeof module ? e(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], e) : e(CodeMirror)
    ...
    var n = "CodeMirror-activeline", a = "CodeMirror-activeline-background";
    ...
    function i(t, i, o) {
        var r = t.getLine(i.line), n = t.getTokenAt(i);
    ...
    function o(o, r) {
        for (var n = {
            name: "autoCloseBrackets", Backspace: function (i) {
            ...
            a += o, n["'" + t + "'"] = function (n) {
                ...
                for (var s, d, h = n.listSelections(), u = 0; u < h.length; u++) {
                    ...
                    if (g.empty()) if (t == o && d == o) f = n.getRange(p, c(p.line, p.ch + 3)) == t + t + t ? "skipThree" : "skip"; else if (t == o && p.ch > 1 && r.indexOf(t) >= 0 && n.getRange(c(p.line, p.ch - 2), p) == t + t && (p.ch <= 2 || n.getRange(c(p.line, p.ch - 3), c(p.line, p.ch - 2)) != t)) f = "addFour"; else if ('"' == t || "'" == t) {
                ...
                n.operation(function () {
                    if ("skip" == s) n.execCommand("goCharRight"); else if ("skipThree" == s) for (var e = 0; 3 > e; e++) n.execCommand("goCharRight"); else if ("surround" == s) {
    ...
    function o(e) {
        e.operation(function () {
            ...
            var c = e.getCursor("from"), d = e.getCursor("to");
    ...
    function r(e, t, i) {
        ...
        if (null !== o.match(/^\w+$/)) {
            if (t.ch > 0) {
                var r = {line: t.line, ch: t.ch - 1}, n = e.getRange(r, t);
                if (null === n.match(/\W/)) return !1
            }
            if (i.ch < e.getLine(t.line).length) {
                var r = {line: i.line, ch: i.ch + 1}, n = e.getRange(i, r);
                if (null === n.match(/\W/)) return !1
            }
            return !0
        }
    ...
    var s = 2, l = "matchhighlight", c = 100, d = !1;
